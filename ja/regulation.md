...
予備対戦（デイリーコンテスト）が開催されます。
[15人村の予備対戦](http://aiwolf.org/daily15/index-j.html)と
[5人村の予備対戦](http://aiwolf.org/daily05/index-j.html)の結果は
各対戦終了後すぐに公開されます。
...
また，人狼知能エージェント簡易生成器が稼働していないため，
簡易生成器により生成されたエージェントの提出もお控えください。
...
ランタイムをlinux-x64に指定してself-containedでpublishした
自己完結コンソールアプリケーションのディレクトリの内容を
...
第5回人狼知能国際大会では
[人狼知能プラットフォーム0.6.x](http://aiwolf.org/server)の利用を想定しています。
...
また，[対戦サーバと同環境のdockerイメージ](https://github.com/users/aiwolf/packages/container/package/aiwolf/)を提供しています。
エージェントの検証にお役立てください。
...
- 2023年04月29日 Version 2023.04.29-ja 第5回国際大会向け初版
- 2023年05月09日 Version 2023.05.09-ja 第4回固有の表現を修正
- 2023年05月10日 Version 2023.05.10-ja エージェント簡易生成器停止に伴い生成エージェントの受付を停止
